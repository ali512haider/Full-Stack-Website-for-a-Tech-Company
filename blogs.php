  ...
  <div class="nav-container">
    ...
    <nav class="nav-links" id="nav-links">
      <ul>
        ...
        <li><a href="blogs.php" style="color: rgba(15, 124, 35, 1);">Blogs</a></li>
...
<!-- Header End!! -->
 <!-- Hero -->
  ...
  <div class="services-overlays blog">
    <div class="hero-nav">
        <span class="nav-title-bar">Home</span> <img src="images/icon.png" alt="" class="icons"> <span class="contact">Blogs</span></p>
    </div>
    <h2>Insights & Resources</h2>
   <p>Short, practical articles and guides on governance, risk, and compliance designed for leaders who need fast, clear answers.</p>
  </div>
...
<section class="award-section blog-section" id="blog">
  ...
  <div class="blog-cards">
    ...
    <div class="blog-card">
      <img src="images/blog4.jpg" alt="Fintech">
      <div class="blog-tags">
        <span>2 min read</span>
        <span>Thought Leadership</span>
      </div>
      <h3>Myth vs Fact: Is Compliance a Business Blocker?</h3>
      <p class="blog-meta">Debunking the top myths leaders believe about compliance and how to turn it into a growth enabler.</p>
    </div>
    <div class="blog-card">
      <img src="images/blog5.png" alt="Fintech">
      <div class="blog-tags">
        <span> 3 min read</span>
        <span>Frameworks</span>
      </div>
      <h3>NIST vs ISO Choosing the Right Framework</h3>
      <p class="blog-meta">A practical comparison to help you decide which framework fits your organization today.</p>
    </div>
    <div class="blog-card">
      <img src="images/blog6.png" alt="Fintech">
      <div class="blog-tags">
        <span>4 min read</span>
        <span>Strategy</span>
      </div>
      <h3>The Future of Cyber Risk: AI, Regulations, & Boards</h3>
      <p class="blog-meta">What boards and CISOs should prepare for as AI reshapes both risk and regulatory expectations.</p>
    </div>
  </div>
<div class="see-more-container">
 ...
 <!-- FAQs Section Ends -->
  ...
  <section class="cta-section" id="contact" style="background-color: #002135; ">
    ...
    <p>Ready to convert a strategy into a certified program? Our team can help.</p>
